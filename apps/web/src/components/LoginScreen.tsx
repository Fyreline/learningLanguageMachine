...
/** Household sign-in — port of Mishka's LoginScreen.tsx styling
 * (docs/DESIGN.md §8). There is no registration path anywhere: this form
 * only ever has one possible "correct" answer per household member, and the
      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          ...
          <p className="font-serif text-base text-ink-mid">
            The path to Japan starts with sumimasen.
          </p>
        </div>
