 ...
 * could flash/flip on first render). Straight port of Mishka Hub's
 * ThemeToggle.tsx, storage key renamed to `michi-theme` (docs/DESIGN.md §1). */
