...
Mirrors docs/DATA_MODEL.md and Mishka Hub's app/db.py. This module only
builds the engine/session machinery; table creation is done once on startup
in app/main.py's lifespan (SQLite; no Alembic in Phase 1 — see
...
def _set_sqlite_pragmas(dbapi_connection, connection_record) -> None:  # noqa: ANN001
    ...
    trip over SQLite's file locking (matches Mishka's convention)."""
